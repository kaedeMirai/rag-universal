...
export RAG_RERANKER_TOP_K="24"
export RAG_RERANKER_WEIGHT="0.65"
...
export RAG_RERANKER_PROVIDER="huggingface"
export RAG_RERANKER_MODEL="BAAI/bge-reranker-v2-m3"
export RAG_RERANKER_DEVICE="cuda"
export RAG_RERANKER_BATCH_SIZE="8"
export RAG_RERANKER_MAX_LENGTH="512"
```
